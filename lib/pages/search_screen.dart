...
class SearchScreen extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    ...
    if (query.isNotEmpty) {
      _currentWeatherData = _dataService.getCurrentWeatherByCity(city: query);
    }
                  ...
                  GridView.count(
                    ...
                    children: <Widget>[
                      ...
                      SubWeather(
                        ...
                        title: 'Độ ẩm',
                        value: '${_currentWeather.main.humidity.toString()} %',
                        description: '',
                      ),
                      SubWeather(
                        icon: Icons.waves_outlined,
                        title: 'Tốc độ gió',
                        value: '${_currentWeather.wind.speed.toString()} km/h',
                        description: '',
                      ),
                      SubWeather(
